...
#    Updated: 2017/04/15 20:32:33 by ariard           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
class Program:
    def __init__(self, parse, program):
        if parse.get(program, "command"):
            ...
            self.exitcodes = int(parse.get(program, "exitcodes"))
            self.startsecs = int(parse.get(program, "startsecs"))
            self.startretries = int(parse.get(program, "startretries"))
